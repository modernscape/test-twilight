...
export default function Home() {
  ...
  return (
    ...
    <div className="flex-1 flex flex-col md:flex-row w-full relative h-full">
      {/* コンテンツエリア */}
      <div className="absolute inset-0 md:relative md:inset-auto md:flex-none md:w-[400px] landscape:relative landscape:inset-auto landscape:flex-none landscape:w-[250px] flex flex-col justify-center items-center p-10 z-20 pointer-events-none md:pointer-events-auto landscape:p-4">
        {/* ロゴコンテナ */}
        <div className="w-[280px] max-w-[280px] md:max-w-[500px] landscape:w-[160px] landscape:max-w-[160px] flex flex-col items-center">
          <div className="w-full pb-6 landscape:pb-2 text-center">
            <Image src={`logo.png`} alt="Main Logo" width={800} height={300} className="w-full h-auto object-contain" priority />
          </div>
      ...
      {/* 画像エリア */}
      <div className="absolute inset-0 p-0 md:relative md:inset-auto md:flex-1 md:pt-24 md:pl-0 md:pb-12 landscape:relative landscape:inset-auto landscape:flex-1 landscape:px-4 landscape:pt-10 landscape:pb-0 z-10">
